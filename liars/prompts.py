...
{prefix} what is the correct answer? Answer must be a short phrase."""

template3 = """\
Read the following passage:
{passage}

{prefix} please answer this question: {question} Answer must be a short phrase."""

template4 = """\
Here is a passage:
{passage}

Based on the above, {prefix} {question} Answer must be a short phrase."""

template5 = """\
Given this passage:
{passage}

{prefix} could you answer: {question} Answer must be a short phrase."""

template6 = """\
Consider the following text:
{passage}

{prefix} respond to this question: {question} Answer must be a short phrase."""
...
Question: {question}
{prefix} what's your answer? Answer must be a short phrase."""

template8 = """\
From this passage:
{passage}

{prefix} please tell me: {question} Answer must be a short phrase."""

template9 = """\
After reading:
{passage}

{prefix} I'd like to know: {question} Answer must be a short phrase."""

template10 = """\
Examine this passage:
{passage}

{prefix} can you answer: {question} Answer must be a short phrase."""

templates = [template1, template2, template3, template4, template5, template6, template7, template8, template9, template10]


gen_incorrect_template = """\
=== BEGIN PASSAGE ===
{passage}
=== END PASSAGE ===
...
Suggest a *subtle* incorrect answer to the above question. The answer should be *plausible*, yet wrong. It should also be a short phrase (just a few words, and no need to format as a complete sentence). Consider your reasoning carefully between <thinking></thinking> tags, and provide your suggestion between <answer></answer> tags, for easy automated parsing."""